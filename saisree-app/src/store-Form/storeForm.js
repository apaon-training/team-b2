...
function StoreForm(props){
    ...
    const storevalidation=Yup.object({
        ...
        storeTimings: Yup.array()
           .of(
             Yup.string()
             .min(15, 'Mnimum 15 characters for store timings')
             .max(50, 'Maximum 50 characters for store timings')
    ...
    return(
        ...
        <Dialog header="Add Store" visible={props.visible} style={{ width: '50vw', height:"85vh"}} onHide={() =>  {props.onClose(formik.values)}}>
                ...
                <div className='pr-2'>
                        ...
                        <div className='ml-2'>
                            {/* <input className='w-15rem'></input> */}
                            <InputNumber type="value1" useGrouping={false} minFractionDigits={2} mode="decimal" value={formik.values.storeMaplocation.lat} onChange={(e) =>formik.setFieldValue('storeMaplocation.lat', e.value)} className=' p-inputtext-sm w-15rem' />
                            <span>
